...
# _version_extra = 'dev'
_version_extra = 2  # Uncomment this for full releases
...
description = "customplotting: make publishable quality science figures quickly"
...
REQUIRES = ["numpy", "matplotlib", "matplotlib_scalebar"]
